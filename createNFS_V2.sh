...
#sudo ./createNFS.sh <mount_path_Generic_ip> <mount_path_Smarta_ip> <generic_volume_path> <smarta_volume_path> <system_user_id> <system_group_id>
#sudo ./createNFS.sh 10.246.4.68 10.246.4.69 smax-generic-qa smax-volume-qa 1999 1999
